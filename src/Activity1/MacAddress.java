...
public class MacAddress {
    ...
    public String obtenerMac() throws SocketException {
        ...
        try {
            ...
            //Recorrido del array de Bytes y transformación en hexadecimal para cada segmento
            for (int i = 0; i < mac.length; i++) {
                cadenaMac.append(String.format("%02X%s", mac[i], (i < mac.length - 1) ? "-" : ""));  //Añadiendo caracteres transformados al objeto de StringBuild
            }
